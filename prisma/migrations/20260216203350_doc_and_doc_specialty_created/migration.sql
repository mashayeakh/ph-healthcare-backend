-- CreateEnum
CREATE TYPE "DoctorGender" AS ENUM ('MALE', 'FEMALE');
...
CREATE TABLE "doctor" (
    ...
    "gender" "DoctorGender" NOT NULL,
    "appiontmentFee" DOUBLE PRECISION NOT NULL,
...
-- CreateIndex
CREATE INDEX "doctor_specialties_doctorId_specialtyId_idx" ON "doctor_specialties"("doctorId", "specialtyId");
